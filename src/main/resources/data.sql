...
-- usersテーブル
INSERT IGNORE INTO users (id, role_id, user_name, furigana, email, phone_number, password,  enabled) VALUES (1, 1, '侍 義勝', 'サムライ ヨシカツ', 'yoshikatsu.samurai@example.com', '090-1234-5678', 'password', false);
INSERT IGNORE INTO users (id, role_id, user_name, furigana, email, phone_number, password,  enabled) VALUES (2, 1, '侍 幸美', 'サムライ サチミ', 'sachimi.samurai@example.com', '090-1234-5678', 'password', false);
INSERT IGNORE INTO users (id, role_id, user_name, furigana, email, phone_number, password,  enabled) VALUES (3, 1, '侍 雅', 'サムライ ミヤビ', 'miyabi.samurai@example.com', '090-1234-5678', 'password', false);
...
-- restaurantsテーブル
INSERT IGNORE INTO restaurants (id, restaurant_name, description, min_price, max_price, capacity, opening_time. closing_time, closed_days, postal_code, address, phone_number) VALUES (1, 'SAMURAIの宿', 'restaurant01.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。長期滞在も可能です。', 6000, 2, '073-0145', '北海道砂川市西五条南X-XX-XX', '012-345-678');
INSERT IGNORE INTO restaurants (id, restaurant_name, description, min_price, max_price, capacity, opening_time. closing_time, closed_days, postal_code, address, phone_number) VALUES (2, 'ペンション SAMURAI', 'restaurant02.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。長期滞在も可能です。', 7000, 3, '030-0945', '青森県青森市桜川X-XX-XX', '012-345-678');
INSERT IGNORE INTO restaurants (id, restaurant_name, description, min_price, max_price, capacity, opening_time. closing_time, closed_days, postal_code, address, phone_number) VALUES (3, 'SAMURAI荘', 'restaurant03.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。長期滞在も可能です。', 8000, 4, '029-5618', '岩手県和賀郡西和賀町沢内両沢X-XX-XX', '012-345-678');
INSERT IGNORE INTO restaurants (id, restaurant_name, description, min_price, max_price, capacity, opening_time. closing_time, closed_days, postal_code, address, phone_number) VALUES (4, 'ゲストハウス SAMURAI', 'restaurant04.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。長期滞在も可能です。', 9000, 5, '989-0555', '宮城県刈田郡七ヶ宿町滝ノ上X-XX-XX', '012-345-678');
INSERT IGNORE INTO restaurants (id, restaurant_name, description, min_price, max_price, capacity, opening_time. closing_time, closed_days, postal_code, address, phone_number) VALUES (5, 'SAMURAI屋', 'restaurant05.jpg', '最寄り駅から徒歩10分。自然豊かで閑静な場所にあります。長期滞在も可能です。', 10000, 6, '018-2661', '秋田県山本郡八峰町八森浜田X-XX-XX', '012-345-678');
...
-- favoriteテーブルにデータを挿入
INSERT INTO favorite (id, user_id, restaurant_id) VALUES1, 1, 1 );
